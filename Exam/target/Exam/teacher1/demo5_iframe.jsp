...
<body>
	...
	<div id="bodw"style="background-color:white;text-align: center;height:240px; ">
		...
		<div style="background-color: #60ac62;height:65px;">
			...
			<a href="./teach_plan.jsp"target="iframe_a">
		...
		<div id="bodbd"style="background-color:white;">
			<p style="font-size:23px;float:left;">教学计划列表</p>
			<div id="xl">
			<form action="">
	...
	font-size: 16px;text-align: center;color: white;value="确认">确认</button>
				<button style="background-color:green;border: 8px;width:15%;
	font-size: 16px;text-align: center;color: white;value="取消">取消</button>
			</form>	
			</div>
